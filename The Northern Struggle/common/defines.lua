...
diplomacy = {
	...
	PEACE_COST_ANNEX = 85,
  PEACE_COST_TAKE_CAPITAL = 40,
  PEACE_COST_CONQUEST_ANY = 85,
	...
	INFAMY_STATUS_QUO = 0,
	INFAMY_ANNEX = 10,
  INFAMY_TAKE_CAPITAL = 10,
  INFAMY_CONQUEST_ANY = 10,
  ...
  PRESTIGE_TAKE_CAPITAL_BASE = 2,
  PRESTIGE_CONQUEST_ANY_BASE = 2,
	...
	PRESTIGE_ANNEX = 0.02,
  PRESTIGE_TAKE_CAPITAL = 0.0.2,
  PRESTIGE_CONQUEST_ANY = 0.0.2,
  ...
  BREAKTRUCE_INFAMY_TAKE_CAPITAL = 1,
BREAKTRUCE_INFAMY_CONQUEST_ANY = 1,	BREAKTRUCE_INFAMY_DEMAND_STATE = 1,
  ...
  BREAKTRUCE_PRESTIGE_TAKE_CAPITAL = -20,

BREAKTRUCE_PRESTIGE_CONQUEST_ANY = -20,	BREAKTRUCE_PRESTIGE_DEMAND_STATE = -20,
  ...
  BREAKTRUCE_MILITANCY_TAKE_CAPITAL = 2,

BREAKTRUCE_MILITANCY_CONQUEST_ANY = 2,	BREAKTRUCE_MILITANCY_DEMAND_STATE = 2,
...
GOODRELATION_INFAMY_TAKE_CAPITAL = 1,
GOODRELATION_INFAMY_CONQUEST_ANY = 1,	GOODRELATION_INFAMY_DEMAND_STATE = 1,
...
GOODRELATION_PRESTIGE_CONQUEST_ANY = -20,
GOODRELATION_PRESTIGE_TAKE_CAPITAL = -20,	GOODRELATION_PRESTIGE_DEMAND_STATE = -20,
...
GOODRELATION_MILITANCY_TAKE_CAPITAL = 2,
GOODRELATION_MILITANCY_CONQUEST_ANY = 2,	GOODRELATION_MILITANCY_DEMAND_STATE = 2,
	...
	MIN_WARSCORE_TO_INTERVENE = -20,
	MIN_MONTHS_TO_INTERVENE = 2,
